...
// New items XLSX adds PriceLevels placeholder and Code Status after Outlets
const NEW_ITEM_HEADERS = [...EXPORT_HEADERS, 'PriceLevels', 'Code Status'];
...
export function generateNewItemXLSX(requests: RequestRow[]): Buffer {
  const rows = requests.map((r) => ({
    ...
    Outlets: r.outlets,
    PriceLevels: '',
    'Code Status': r.codeIsAutoGenerated === false ? 'MANUAL' : 'AUTO',
  }));
