...
const OUTLET_ENTRIES = [
  ...
  { term: 'UPKW', definition: 'Union PIK Weekend — Union Group', grp: 'UNION' },
  ...
  { term: 'CSPI', definition: 'CNS PIK — CNS Group', grp: 'CNS' },
  { term: 'CSPP', definition: 'CNS Pondok Indah — CNS Group', grp: 'CNS' },
  { term: 'CSSG', definition: 'CNS Senayan City — CNS Group', grp: 'CNS' },
  { term: 'CSPI-B', definition: 'CNS PIK (Internal) — CNS Group', grp: 'CNS' },
  { term: 'CSPP-B', definition: 'CNS Pondok Indah (Internal) — CNS Group', grp: 'CNS' },
  { term: 'CSSG-B', definition: 'CNS Senayan City (Internal) — CNS Group', grp: 'CNS' },
  { term: 'BLCS', definition: 'Barluca Senayan City — CNS Group (BLC prefix)', grp: 'CNS' },
