  ...
  return (
    <div className="lp-root">
      ...
      <div className="lp-bg">
        ...
        />
        {/* Mobile/tablet: warm full overlay. Desktop: overridden to near-invisible. */}
      ...
      <div className="lp-layout">
        ...
        {/* Card: glass on mobile/tablet → solid warm panel on desktop */}
        <div className="lp-card">
          <div className="lp-card-body">
            ...
            <p className="lp-hint">
              Need access? <span>Contact your manager.</span>
            </p>
          </div>
