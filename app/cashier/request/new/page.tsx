...
export default function NewRequestPage() {
  ...
  // For UPDATE_PRICE / UPDATE_NAME: set code and populate reference fields, but keep the editable new value untouched
  function handleUpdateItemSelect(item: PLUSearchResult) {
      ...
      <form onSubmit={handleSubmit} style={{ maxWidth: '680px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '0.5rem', flexWrap: 'wrap' }}>
            {REQUEST_TYPES.map((t) => (
              <button
                key={t.value}
                type="button"
                onClick={() => { set('requestType', t.value); setErrors({}); setRefItem(null); }}
                style={{
        ...
        {!isRemovePLU && isUpdate && (
          <div className="card" style={{ padding: '1.5rem', marginBottom: '1rem' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
              <FieldGroup label="PLU Code" hint="Search or type the PLU code of the item to update">
                <PLUCodeSearch
                  value={form.code}
                  onChange={handlePLUSearchChange}
                  onItemSelect={handleUpdateItemSelect}
              ...
              {/* Reference fields — auto-populated from master item, display only */}
        ...
        <div style={{ display: 'flex', gap: '0.75rem' }}>
          ...
          <button type="button" onClick={() => { setForm(DEFAULT_FORM); setErrors({}); setRefItem(null); }}
