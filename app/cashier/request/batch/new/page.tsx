...
export default function BatchNewPage() {
  ...
  const addRow = useCallback(() => {
    setItems((prev) => {
      ...
      const newRow: ItemRow = {
        ...
        codeLoading: hasCategory && requestType === 'NEW_ITEM', name: '', remarks: '', errors: {},
      };
      return [...prev, newRow];
    });
  // eslint-disable-next-line react-hooks/exhaustive-deps
  ...
  function handleCodeSearchChange(idx: number, code: string) {
    ...
    setItems((prev) => prev.map((r, i) => i !== idx ? r : { ...r, code, codeIsAutoGenerated: false, errors: { ...r.errors, code: undefined } }));
  }
            ...
            <table style={{ tableLayout: 'auto', minWidth: isRemovePLU ? '600px' : '900px' }}>
              <thead>
                <tr>
                  ...
                  {/* Standard columns */}
                  {!isRemovePLU && (isUpdate || requestType === 'NEW_ITEM') && <th style={{ minWidth: '160px' }}>Code</th>}
